            ...
            <?php while(have_posts()): the_post(); ?>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <h5 class="card-title mb-4"><i class="fa fa-area-chart"></i> Area Chart Example</h5>
                        ...
                        <div class="mb-0 mt-4">
                            <h5><i class="fa fa-newspaper-o"></i> News Feed</h5>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-3">
                            <div class="card text-white bg-primary o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <h5 class="mr-5 mb-2">26 New Messages!</h5>
                                    <a href="#" class="text-white small">
                                      <span>View Details <i class="fa fa-fw fa-angle-right"></i></span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="card text-white bg-success o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <h5 class="mr-5 mb-2">11 New Orders!</h5>
                                    <a href="#" class="text-white small">
                                      <span>View Details <i class="fa fa-fw fa-angle-right"></i></span>
                                    </a>
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="card text-white bg-danger o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <h5 class="mr-5 mb-2">13 New Tickets!</h5>
                                    <a href="#" class="text-white small">
                                      <span>View Details <i class="fa fa-fw fa-angle-right"></i></span>
                                    </a>
                                </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <h5 class="card-title mb-4"><i class="fa fa-pie-chart"></i> Pie Chart Example</h5>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <a href="#" class="btn btn-light btn-sm float-right" style="margin-top:-4px;">View All</a>
                                <h5 class="card-title mb-0"><i class="fa fa-bell-o"></i> Feed Example</h5>
                            </div>
                            <div class="list-group list-group-flush small">
                                <a class="list-group-item list-group-item-action" href="#">
                                    <div class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="https://picsum.photos/45/45" alt="">
                                        <div class="media-body">
                                            <strong>David Miller</strong> posted a new article to <strong>David Miller Website</strong>.
                                            <div class="text-muted smaller mt-1">Today at 5:43 PM - 5m ago</div>
                                        </div>
                                    </div>
                                </a>
                                <a class="list-group-item list-group-item-action" href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="text-muted smaller mt-1">Today at 4:37 PM - 1hr ago</div>
                                        </div>
                                    </div>
                                </a>
                                <a class="list-group-item list-group-item-action" href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="text-muted smaller mt-1">Today at 4:31 PM - 1hr ago</div>
                                        </div>
                                    </div>
                                </a>
                                <a class="list-group-item list-group-item-action" href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="text-muted smaller mt-1">Today at 3:54 PM - 2hrs ago</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><i class="fa fa-table"></i> Data Table Example</h5>
                    </div>
